...
struct PrismDIDMethodId: CustomStringConvertible {
    ...
    init(sections: [String]) throws {
        ...
        else { throw CastorError.methodIdIsDoesNotSatisfyRegex(regex: "^([A-Za-z0-9_-]*:)*[A-Za-z0-9_-]+$") }
    ...
    init(string: String) throws {
        ...
        else { throw CastorError.methodIdIsDoesNotSatisfyRegex(regex: methodSpecifiIdRegex) }
        value = string
    }
}
