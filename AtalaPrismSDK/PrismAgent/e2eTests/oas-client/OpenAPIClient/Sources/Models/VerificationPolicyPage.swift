...
public struct VerificationPolicyPage: Codable {
    public var _self: String
    public var kind: String
    public var pageOf: String
    public var next: String?
    public var previous: String?
    public var contents: [VerificationPolicy]?

    public init(_self: String, kind: String, pageOf: String, next: String? = nil, previous: String? = nil, contents: [VerificationPolicy]? = nil) {
        self._self = _self
        self.kind = kind
        self.pageOf = pageOf
        self.next = next
    ...
    public init(from decoder: Decoder) throws {
        ...
        contents = try container.decodeIfPresent([VerificationPolicy].self, forKey: .contents)
    }
