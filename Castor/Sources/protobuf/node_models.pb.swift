...
enum Io_Iohk_Atala_Prism_Protos_KeyUsage: SwiftProtobuf.Enum {
  ...
  case capabilityInvocationKey // = 6
  ...
  case capabilityDelegationKey // = 7
  ...
  init?(rawValue: Int) {
    ...
    case 3: self = .keyAgreementKey
    case 4: self = .authenticationKey
    case 5: self = .revocationKey
    case 6: self = .capabilityInvocationKey
  ...
  var rawValue: Int {
    ...
    case .keyAgreementKey: return 3
    case .authenticationKey: return 4
    case .revocationKey: return 5
    case .capabilityInvocationKey: return 6
    case .capabilityDelegationKey: return 7
...
struct Io_Iohk_Atala_Prism_Protos_PublicKey {
  ...
  var compressedEcKeyData: Io_Iohk_Atala_Prism_Protos_CompressedECKeyData {
    get {
      if case .compressedEcKeyData(let v)? = _storage._keyData {return v}
  ...
  enum OneOf_KeyData: Equatable {
    ...
    static func ==(lhs: Io_Iohk_Atala_Prism_Protos_PublicKey.OneOf_KeyData, rhs: Io_Iohk_Atala_Prism_Protos_PublicKey.OneOf_KeyData) -> Bool {
      ...
      case (.ecKeyData, .ecKeyData): return {
        guard case .ecKeyData(let l) = lhs, case .ecKeyData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.compressedEcKeyData, .compressedEcKeyData): return {
        guard case .compressedEcKeyData(let l) = lhs, case .compressedEcKeyData(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
struct Io_Iohk_Atala_Prism_Protos_DIDData {
  ...
  var services: [Io_Iohk_Atala_Prism_Protos_Service] = []
...
struct Io_Iohk_Atala_Prism_Protos_CreateDIDOperation {
  ...
  mutating func clearDidData() {self._didData = nil}
  ...
  fileprivate var _didData: Io_Iohk_Atala_Prism_Protos_CreateDIDOperation.DIDCreationData? = nil
}
...
struct Io_Iohk_Atala_Prism_Protos_AddKeyAction {
  ...
  fileprivate var _key: Io_Iohk_Atala_Prism_Protos_PublicKey? = nil
}
...
struct Io_Iohk_Atala_Prism_Protos_AddServiceAction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var service: Io_Iohk_Atala_Prism_Protos_Service {
    get {return _service ?? Io_Iohk_Atala_Prism_Protos_Service()}
  ...
  fileprivate var _service: Io_Iohk_Atala_Prism_Protos_Service? = nil
}

struct Io_Iohk_Atala_Prism_Protos_RemoveServiceAction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Io_Iohk_Atala_Prism_Protos_UpdateServiceAction {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Io_Iohk_Atala_Prism_Protos_UpdateDIDAction {
  ...
  var action: Io_Iohk_Atala_Prism_Protos_UpdateDIDAction.OneOf_Action? = nil

  /// Used to add a new key to the DID.
  var addKey: Io_Iohk_Atala_Prism_Protos_AddKeyAction {
    get {
      if case .addKey(let v)? = action {return v}
  ...
  var removeKey: Io_Iohk_Atala_Prism_Protos_RemoveKeyAction {
    get {
      if case .removeKey(let v)? = action {return v}
  ...
  var addService: Io_Iohk_Atala_Prism_Protos_AddServiceAction {
    get {
      if case .addService(let v)? = action {return v}
      return Io_Iohk_Atala_Prism_Protos_AddServiceAction()
    }
    set {action = .addService(newValue)}
  }

  /// Used to remove an existing service from a DID,
  var removeService: Io_Iohk_Atala_Prism_Protos_RemoveServiceAction {
    get {
      if case .removeService(let v)? = action {return v}
      return Io_Iohk_Atala_Prism_Protos_RemoveServiceAction()
    }
    set {action = .removeService(newValue)}
  }

  /// Used to Update a list of service endpoints of a given service on a given DID.
  var updateService: Io_Iohk_Atala_Prism_Protos_UpdateServiceAction {
    get {
      if case .updateService(let v)? = action {return v}
      return Io_Iohk_Atala_Prism_Protos_UpdateServiceAction()
    }
    set {action = .updateService(newValue)}
  }
  ...
  enum OneOf_Action: Equatable {
    ...
    /// Used to add a new service to a DID,
    case addService(Io_Iohk_Atala_Prism_Protos_AddServiceAction)
    /// Used to remove an existing service from a DID,
    case removeService(Io_Iohk_Atala_Prism_Protos_RemoveServiceAction)
    /// Used to Update a list of service endpoints of a given service on a given DID.
    case updateService(Io_Iohk_Atala_Prism_Protos_UpdateServiceAction)
    ...
    static func ==(lhs: Io_Iohk_Atala_Prism_Protos_UpdateDIDAction.OneOf_Action, rhs: Io_Iohk_Atala_Prism_Protos_UpdateDIDAction.OneOf_Action) -> Bool {
      ...
      case (.removeKey, .removeKey): return {
        guard case .removeKey(let l) = lhs, case .removeKey(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.addService, .addService): return {
        guard case .addService(let l) = lhs, case .addService(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.removeService, .removeService): return {
        guard case .removeService(let l) = lhs, case .removeService(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
...
struct Io_Iohk_Atala_Prism_Protos_UpdateDIDOperation {
  ...
  var previousOperationHash: Data = Data()
...
struct Io_Iohk_Atala_Prism_Protos_IssueCredentialBatchOperation {
  ...
  mutating func clearCredentialBatchData() {self._credentialBatchData = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _credentialBatchData: Io_Iohk_Atala_Prism_Protos_CredentialBatchData? = nil
}
...
struct Io_Iohk_Atala_Prism_Protos_ProtocolVersionUpdateOperation {
  ...
  fileprivate var _version: Io_Iohk_Atala_Prism_Protos_ProtocolVersionInfo? = nil
}
...
struct Io_Iohk_Atala_Prism_Protos_ProtocolVersionInfo {
  ...
  fileprivate var _protocolVersion: Io_Iohk_Atala_Prism_Protos_ProtocolVersion? = nil
}
...
struct Io_Iohk_Atala_Prism_Protos_AtalaOperation {
  ...
  var operation: Io_Iohk_Atala_Prism_Protos_AtalaOperation.OneOf_Operation? = nil

  /// Used to create a public DID.
  var createDid: Io_Iohk_Atala_Prism_Protos_CreateDIDOperation {
    get {
      if case .createDid(let v)? = operation {return v}
  ...
  var updateDid: Io_Iohk_Atala_Prism_Protos_UpdateDIDOperation {
    get {
      if case .updateDid(let v)? = operation {return v}
  ...
  var issueCredentialBatch: Io_Iohk_Atala_Prism_Protos_IssueCredentialBatchOperation {
    get {
      if case .issueCredentialBatch(let v)? = operation {return v}
  ...
  var revokeCredentials: Io_Iohk_Atala_Prism_Protos_RevokeCredentialsOperation {
    get {
      if case .revokeCredentials(let v)? = operation {return v}
  ...
  var protocolVersionUpdate: Io_Iohk_Atala_Prism_Protos_ProtocolVersionUpdateOperation {
    get {
      if case .protocolVersionUpdate(let v)? = operation {return v}
  ...
  var deactivateDid: Io_Iohk_Atala_Prism_Protos_DeactivateDIDOperation {
    get {
      if case .deactivateDid(let v)? = operation {return v}
  ...
  enum OneOf_Operation: Equatable {
    ...
    static func ==(lhs: Io_Iohk_Atala_Prism_Protos_AtalaOperation.OneOf_Operation, rhs: Io_Iohk_Atala_Prism_Protos_AtalaOperation.OneOf_Operation) -> Bool {
      ...
      case (.createDid, .createDid): return {
        guard case .createDid(let l) = lhs, case .createDid(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.updateDid, .updateDid): return {
        guard case .updateDid(let l) = lhs, case .updateDid(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.issueCredentialBatch, .issueCredentialBatch): return {
        guard case .issueCredentialBatch(let l) = lhs, case .issueCredentialBatch(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.revokeCredentials, .revokeCredentials): return {
        guard case .revokeCredentials(let l) = lhs, case .revokeCredentials(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.protocolVersionUpdate, .protocolVersionUpdate): return {
        guard case .protocolVersionUpdate(let l) = lhs, case .protocolVersionUpdate(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.deactivateDid, .deactivateDid): return {
        guard case .deactivateDid(let l) = lhs, case .deactivateDid(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
struct Io_Iohk_Atala_Prism_Protos_SignedAtalaOperation {
  ...
  fileprivate var _operation: Io_Iohk_Atala_Prism_Protos_AtalaOperation? = nil
}
...
struct Io_Iohk_Atala_Prism_Protos_LedgerData {
  ...
  mutating func clearTimestampInfo() {self._timestampInfo = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _timestampInfo: Io_Iohk_Atala_Prism_Protos_TimestampInfo? = nil
}
...
struct Io_Iohk_Atala_Prism_Protos_OperationOutput {
  ...
  var result: Io_Iohk_Atala_Prism_Protos_OperationOutput.OneOf_Result? = nil
  ...
  var batchOutput: Io_Iohk_Atala_Prism_Protos_IssueCredentialBatchOutput {
    get {
      if case .batchOutput(let v)? = result {return v}
  ...
  var createDidOutput: Io_Iohk_Atala_Prism_Protos_CreateDIDOutput {
    get {
      if case .createDidOutput(let v)? = result {return v}
  ...
  var updateDidOutput: Io_Iohk_Atala_Prism_Protos_UpdateDIDOutput {
    get {
      if case .updateDidOutput(let v)? = result {return v}
  ...
  var revokeCredentialsOutput: Io_Iohk_Atala_Prism_Protos_RevokeCredentialsOutput {
    get {
      if case .revokeCredentialsOutput(let v)? = result {return v}
  ...
  var protocolVersionUpdateOutput: Io_Iohk_Atala_Prism_Protos_ProtocolVersionUpdateOutput {
    get {
      if case .protocolVersionUpdateOutput(let v)? = result {return v}
  ...
  var deactivateDidOutput: Io_Iohk_Atala_Prism_Protos_DeactivateDIDOutput {
    get {
      if case .deactivateDidOutput(let v)? = result {return v}
      return Io_Iohk_Atala_Prism_Protos_DeactivateDIDOutput()
    }
    set {result = .deactivateDidOutput(newValue)}
  }

  var operationMaybe: Io_Iohk_Atala_Prism_Protos_OperationOutput.OneOf_OperationMaybe? = nil

  /// Operation identifier.
  var operationID: Data {
    get {
      if case .operationID(let v)? = operationMaybe {return v}
      return Data()
    }
  ...
  var error: String {
    get {
      if case .error(let v)? = operationMaybe {return v}
      return String()
    }
  ...
  enum OneOf_Result: Equatable {
    ...
    static func ==(lhs: Io_Iohk_Atala_Prism_Protos_OperationOutput.OneOf_Result, rhs: Io_Iohk_Atala_Prism_Protos_OperationOutput.OneOf_Result) -> Bool {
      ...
      case (.batchOutput, .batchOutput): return {
        guard case .batchOutput(let l) = lhs, case .batchOutput(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.createDidOutput, .createDidOutput): return {
        guard case .createDidOutput(let l) = lhs, case .createDidOutput(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.updateDidOutput, .updateDidOutput): return {
        guard case .updateDidOutput(let l) = lhs, case .updateDidOutput(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.revokeCredentialsOutput, .revokeCredentialsOutput): return {
        guard case .revokeCredentialsOutput(let l) = lhs, case .revokeCredentialsOutput(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.protocolVersionUpdateOutput, .protocolVersionUpdateOutput): return {
        guard case .protocolVersionUpdateOutput(let l) = lhs, case .protocolVersionUpdateOutput(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      case (.deactivateDidOutput, .deactivateDidOutput): return {
        guard case .deactivateDidOutput(let l) = lhs, case .deactivateDidOutput(let r) = rhs else { preconditionFailure() }
        return l == r
      }()
      default: return false
      }
...
struct Io_Iohk_Atala_Prism_Protos_Service {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var addedOn: Io_Iohk_Atala_Prism_Protos_LedgerData {
    get {return _addedOn ?? Io_Iohk_Atala_Prism_Protos_LedgerData()}
    set {_addedOn = newValue}
  }
  /// Returns true if `addedOn` has been explicitly set.
  var hasAddedOn: Bool {return self._addedOn != nil}
  /// Clears the value of `addedOn`. Subsequent reads from it will return its default value.
  mutating func clearAddedOn() {self._addedOn = nil}

  /// (when present) The ledger details related to the event that revoked the service.
  var deletedOn: Io_Iohk_Atala_Prism_Protos_LedgerData {
    get {return _deletedOn ?? Io_Iohk_Atala_Prism_Protos_LedgerData()}
    set {_deletedOn = newValue}
  }
  /// Returns true if `deletedOn` has been explicitly set.
  var hasDeletedOn: Bool {return self._deletedOn != nil}
  /// Clears the value of `deletedOn`. Subsequent reads from it will return its default value.
  mutating func clearDeletedOn() {self._deletedOn = nil}

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _addedOn: Io_Iohk_Atala_Prism_Protos_LedgerData? = nil
  fileprivate var _deletedOn: Io_Iohk_Atala_Prism_Protos_LedgerData? = nil
}
...
extension Io_Iohk_Atala_Prism_Protos_KeyUsage: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .same(proto: "KEY_AGREEMENT_KEY"),
    4: .same(proto: "AUTHENTICATION_KEY"),
    5: .same(proto: "REVOCATION_KEY"),
    6: .same(proto: "CAPABILITY_INVOCATION_KEY"),
    7: .same(proto: "CAPABILITY_DELEGATION_KEY"),
  ]
}
...
extension Io_Iohk_Atala_Prism_Protos_TimestampInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.blockSequenceNumber) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.operationSequenceNumber) }()
...
extension Io_Iohk_Atala_Prism_Protos_ECKeyData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.curve) }()
      case 2: try { try decoder.decodeSingularBytesField(value: &self.x) }()
      case 3: try { try decoder.decodeSingularBytesField(value: &self.y) }()
      default: break
      }
    }
  }
...
extension Io_Iohk_Atala_Prism_Protos_PublicKey: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _addedOn: Io_Iohk_Atala_Prism_Protos_LedgerData? = nil
    var _revokedOn: Io_Iohk_Atala_Prism_Protos_LedgerData? = nil
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 9: try {
          ...
          if let current = _storage._keyData {
            hadOneofValue = true
            if case .compressedEcKeyData(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .ecKeyData?: try {
        guard case .ecKeyData(let v)? = _storage._keyData else { preconditionFailure() }
        try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
      }()
      case .compressedEcKeyData?: try {
        guard case .compressedEcKeyData(let v)? = _storage._keyData else { preconditionFailure() }
...
extension Io_Iohk_Atala_Prism_Protos_CreateDIDOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._didData) }()
      default: break
      }
    }
  }
...
extension Io_Iohk_Atala_Prism_Protos_AddServiceAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AddServiceAction"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Io_Iohk_Atala_Prism_Protos_AddServiceAction, rhs: Io_Iohk_Atala_Prism_Protos_AddServiceAction) -> Bool {
...
extension Io_Iohk_Atala_Prism_Protos_RemoveServiceAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".RemoveServiceAction"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  static func ==(lhs: Io_Iohk_Atala_Prism_Protos_RemoveServiceAction, rhs: Io_Iohk_Atala_Prism_Protos_RemoveServiceAction) -> Bool {
...
extension Io_Iohk_Atala_Prism_Protos_UpdateServiceAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".UpdateServiceAction"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "serviceId"),
    2: .same(proto: "type"),
    3: .standard(proto: "service_endpoints"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.serviceEndpoints) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.serviceEndpoints.isEmpty {
      try visitor.visitRepeatedStringField(value: self.serviceEndpoints, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Io_Iohk_Atala_Prism_Protos_UpdateServiceAction, rhs: Io_Iohk_Atala_Prism_Protos_UpdateServiceAction) -> Bool {
    if lhs.serviceID != rhs.serviceID {return false}
    if lhs.type != rhs.type {return false}
    if lhs.serviceEndpoints != rhs.serviceEndpoints {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Io_Iohk_Atala_Prism_Protos_UpdateDIDAction: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    3: .standard(proto: "add_service"),
    4: .standard(proto: "remove_service"),
    5: .standard(proto: "update_service"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try {
        var v: Io_Iohk_Atala_Prism_Protos_AddServiceAction?
        var hadOneofValue = false
        if let current = self.action {
          hadOneofValue = true
        ...
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.action = .addService(v)
        }
      }()
      case 4: try {
        var v: Io_Iohk_Atala_Prism_Protos_RemoveServiceAction?
        var hadOneofValue = false
        if let current = self.action {
          hadOneofValue = true
          if case .removeService(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.action = .removeService(v)
        }
      }()
      case 5: try {
        var v: Io_Iohk_Atala_Prism_Protos_UpdateServiceAction?
        var hadOneofValue = false
        if let current = self.action {
          hadOneofValue = true
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.action {
    case .addKey?: try {
      guard case .addKey(let v)? = self.action else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .removeKey?: try {
      guard case .removeKey(let v)? = self.action else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .addService?: try {
      guard case .addService(let v)? = self.action else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case .removeService?: try {
      guard case .removeService(let v)? = self.action else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case .updateService?: try {
      guard case .updateService(let v)? = self.action else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }()
    case nil: break
    }
...
extension Io_Iohk_Atala_Prism_Protos_UpdateDIDOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBytesField(value: &self.previousOperationHash) }()
...
extension Io_Iohk_Atala_Prism_Protos_CredentialBatchData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.issuerDid) }()
...
extension Io_Iohk_Atala_Prism_Protos_IssueCredentialBatchOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._credentialBatchData) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if let v = self._credentialBatchData {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Io_Iohk_Atala_Prism_Protos_RevokeCredentialsOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularBytesField(value: &self.previousOperationHash) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.credentialBatchID) }()
      case 3: try { try decoder.decodeRepeatedBytesField(value: &self.credentialsToRevoke) }()
      default: break
      }
    }
  }
...
extension Io_Iohk_Atala_Prism_Protos_ProtocolVersionUpdateOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.proposerDid) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.proposerDid.isEmpty {
      try visitor.visitSingularStringField(value: self.proposerDid, fieldNumber: 1)
    }
...
extension Io_Iohk_Atala_Prism_Protos_ProtocolVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.majorVersion) }()
      case 2: try { try decoder.decodeSingularInt32Field(value: &self.minorVersion) }()
      default: break
      }
    }
  }
...
extension Io_Iohk_Atala_Prism_Protos_ProtocolVersionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.versionName) }()
      case 4: try { try decoder.decodeSingularInt32Field(value: &self.effectiveSince) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._protocolVersion) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.versionName.isEmpty {
      try visitor.visitSingularStringField(value: self.versionName, fieldNumber: 1)
    }
    if self.effectiveSince != 0 {
      try visitor.visitSingularInt32Field(value: self.effectiveSince, fieldNumber: 4)
    }
...
extension Io_Iohk_Atala_Prism_Protos_AtalaOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try {
        ...
        if let current = self.operation {
          hadOneofValue = true
          if case .protocolVersionUpdate(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
      ...
      case 6: try {
        ...
        if let current = self.operation {
          hadOneofValue = true
          if case .deactivateDid(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .createDid?: try {
      guard case .createDid(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .updateDid?: try {
      guard case .updateDid(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .issueCredentialBatch?: try {
      guard case .issueCredentialBatch(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case .revokeCredentials?: try {
      guard case .revokeCredentials(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    case .protocolVersionUpdate?: try {
      guard case .protocolVersionUpdate(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }()
    case .deactivateDid?: try {
      guard case .deactivateDid(let v)? = self.operation else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
    }()
    case nil: break
    }
...
extension Io_Iohk_Atala_Prism_Protos_SignedAtalaOperation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.signedWith) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.signedWith.isEmpty {
      try visitor.visitSingularStringField(value: self.signedWith, fieldNumber: 1)
    }
...
extension Io_Iohk_Atala_Prism_Protos_LedgerData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularEnumField(value: &self.ledger) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._timestampInfo) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.ledger != .unknownLedger {
      try visitor.visitSingularEnumField(value: self.ledger, fieldNumber: 2)
    }
    if let v = self._timestampInfo {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Io_Iohk_Atala_Prism_Protos_OperationOutput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try {
        ...
        if let current = self.result {
          hadOneofValue = true
          if case .batchOutput(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
      ...
      case 2: try {
        ...
        if let current = self.result {
          hadOneofValue = true
          if case .createDidOutput(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
      ...
      case 3: try {
        ...
        if let current = self.result {
          hadOneofValue = true
          if case .updateDidOutput(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
      ...
      case 4: try {
        ...
        if let current = self.result {
          hadOneofValue = true
          if case .revokeCredentialsOutput(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
      ...
      case 7: try {
        ...
        if let current = self.result {
          hadOneofValue = true
          if case .protocolVersionUpdateOutput(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
      ...
      case 8: try {
        ...
        if let current = self.result {
          hadOneofValue = true
          if case .deactivateDidOutput(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .batchOutput?: try {
      guard case .batchOutput(let v)? = self.result else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    }()
    case .createDidOutput?: try {
      guard case .createDidOutput(let v)? = self.result else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
    }()
    case .updateDidOutput?: try {
      guard case .updateDidOutput(let v)? = self.result else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    }()
    case .revokeCredentialsOutput?: try {
      guard case .revokeCredentialsOutput(let v)? = self.result else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }()
    default: break
    }
    ...
    // allocates stack space for every case branch when no optimizations are
    // enabled. https://github.com/apple/swift-protobuf/issues/1034
    switch self.operationMaybe {
    case .operationID?: try {
      guard case .operationID(let v)? = self.operationMaybe else { preconditionFailure() }
      try visitor.visitSingularBytesField(value: v, fieldNumber: 5)
    }()
    case .error?: try {
      guard case .error(let v)? = self.operationMaybe else { preconditionFailure() }
    ...
    case .protocolVersionUpdateOutput?: try {
      guard case .protocolVersionUpdateOutput(let v)? = self.result else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
    }()
    case .deactivateDidOutput?: try {
      guard case .deactivateDidOutput(let v)? = self.result else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
    }()
    default: break
    }
...
extension Io_Iohk_Atala_Prism_Protos_CreateDIDOutput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.didSuffix) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.didSuffix.isEmpty {
      try visitor.visitSingularStringField(value: self.didSuffix, fieldNumber: 1)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Io_Iohk_Atala_Prism_Protos_Service: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Service"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
    2: .same(proto: "type"),
    3: .standard(proto: "service_endpoint"),
    4: .standard(proto: "added_on"),
    5: .standard(proto: "deleted_on"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try { try decoder.decodeSingularStringField(value: &self.id) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.type) }()
      case 3: try { try decoder.decodeRepeatedStringField(value: &self.serviceEndpoint) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._addedOn) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._deletedOn) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.serviceEndpoint.isEmpty {
      try visitor.visitRepeatedStringField(value: self.serviceEndpoint, fieldNumber: 3)
    }
    if let v = self._addedOn {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
    }
    if let v = self._deletedOn {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Io_Iohk_Atala_Prism_Protos_Service, rhs: Io_Iohk_Atala_Prism_Protos_Service) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.type != rhs.type {return false}
    if lhs.serviceEndpoint != rhs.serviceEndpoint {return false}
    if lhs._addedOn != rhs._addedOn {return false}
    if lhs._deletedOn != rhs._deletedOn {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
