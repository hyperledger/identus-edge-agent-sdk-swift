...
* **Check the [Readme](https://github.com/input-output-hk/atala-prism-wallet-sdk-swift/blob/main/README.md) ** if you have problems on the setup and the [discussions](https://github.com/input-output-hk/atala-prism-wallet-sdk-swift/discussions)** for a list of common questions and problems.
